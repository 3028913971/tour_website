...
<title>旅游攻略系统</title>
<meta content="自助游游记,游记" name="keywords">
<meta content="为您的行程提供参考出游前必看的秘籍." name="description">
					...
					<div id="gonglueBox" class="gonglue_box">
						<ul class="btn clear_fix">
							<li style="border-right: 1px solid gray;"><s:a
									cssClass="active" action="travelNoteSecondPage_pageIsTop1"
									namespace="/" theme="simple">
                                热门
                                <s:param name="cityName"
										value="city.cityName"></s:param>
								</s:a></li>
							<li><s:a action="travelNoteSecondPage_pagePublicTime"
									namespace="/" theme="simple">
                                最新
                                <s:param name="cityName"
										value="city.cityName"></s:param>
							...
							<div class="pic_item">
								...
								<div class="pagination">
									<div class="page-bottom">
										<s:url action="travelNoteSecondPage_pageIsTop1" namespace="/"
											id="firstPage">
