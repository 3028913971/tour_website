	...
	<div class="qyWrap">
		<div class="lm-index-sort-wrap clearfix">
			<ul class="lmsifts qyer-sort">
				<li class="active"><s:a action="productCityPage_pageIsTop1"
						namespace="/" theme="simple" style="border-right: 1px solid gray;">
            	热门推荐
		...
		<ul class="lm-index-product-list mt10 clearfix">
			<s:iterator value="isTopCityList">
		...
		<div class="list-pages">
			<div class="ui_page">
				<s:url action="productCityPage_pageIsTop1" namespace="/"
					id="firstPage">
