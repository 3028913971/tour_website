...
<HTML>
	...
	<body>
		...
		<br>
		<s:form action="tdTopPhoto_edit" namespace="/" theme="simple" onsubmit="return CheckNull('isTop','是否热门','isTopError');" enctype="multipart/form-data">
			&nbsp;
			<s:hidden name="tdTopPhotoId" value="%{tdTopPhotoId}"/>
			<s:hidden name="tdTopPhotoFileName" value="%{tdTopPhotoFileName}"/>
			<s:hidden name="tdTopPhotoRealName" value="%{tdTopPhotoRealName}"/>
