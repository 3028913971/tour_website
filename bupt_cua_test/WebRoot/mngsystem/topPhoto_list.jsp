				...
				<TBODY>
								...
								<s:iterator>
									<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td style="CURSOR: hand; HEIGHT: 22px" align="center"
												width="30%">
												<s:property value="topPhotoFileName"/>
											</td>  
											<td style="CURSOR: hand; HEIGHT: 22px" align="center"
												width="30%">
											...
											<td style="CURSOR: hand; HEIGHT: 22px" align="center"
												width="10%">
												<s:property value="topPhotoCity"/>
											</td>
											<td align="center" style="HEIGHT: 22px">
												<s:a action="topPhoto_loadForEdit" namespace="/">
													<s:param name="topPhotoId" value="topPhotoId"/>
													<img src="<c:url value='/images/i_edit.gif'/>" border="0" style="CURSOR: hand">
												</s:a>
											</td>
											<td align="center" style="HEIGHT: 22px">
												<s:a action="topPhoto_delete" namespace="/" onclick="return confirm('您是否真的要删除该记录')">
													<s:param name="topPhotoId" value="topPhotoId"/>
													<s:param name="topPhotoRealName" value="topPhotoRealName"/>
					...
					<tr>
						<td align="center">
							...
							<s:url action="topPhoto_page" namespace="/" id="lastPage">
								<s:param name="pageNum">
