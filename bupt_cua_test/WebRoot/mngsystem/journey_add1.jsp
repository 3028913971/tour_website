...
<HTML>
	...
	<body>
		...
		<br>
		<s:form action="product_addOneJourney" namespace="/" theme="simple" enctype="multipart/form-data" onsubmit="return CheckAdd1JourneyForm();">
			&nbsp;
			<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				...
				<s:hidden name="journeyInfo[0].productName" value = "%{proName}"/>
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff" colspan="3">
						<s:textfield name="%{'journeyInfo[0].journeyDayNumber'}" id="journeyDayNumber" onblur="CheckDayNum('journeyDayNumber','行程第几天','journeyDayNumberError')"/>
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff" colspan="3">
						<s:file name="jfile" id="jfile" onchange="CheckPhotoType('jfile','行程文件','jfileError')"/>
						<span style="color:#ff0000;font-weight: 900;" id="jfileError"/>
					</td>
				</tr>
				<tr>
