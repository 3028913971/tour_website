...
<HTML>
	...
	<body>
		...
		<s:form action="theme_edit" namespace="/" theme="simple" enctype="multipart/form-data" onsubmit="return CheckEditThemeForm();">
			&nbsp;
			<s:hidden name="themeId" value="%{themeId}"/>
			<s:hidden name="themeFileName" value="%{themeFileName}"/>
			<s:hidden name="themeRealName" value="%{themeRealName}"/>
			<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				<tr>
					<td class="ta_01" align="center" bgColor="#afd1f3" colSpan="4"
						height="26">
						<strong><STRONG>编辑主题信息</STRONG>
						</strong>
					</td>
				</tr>
				<tr>
