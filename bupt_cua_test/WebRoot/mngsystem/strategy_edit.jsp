...
<HTML>
	...
	<body>
		...
		<br>
		<s:form action="strategyFile_edit" namespace="/" theme="simple" onsubmit="return CheckStrategyEditForm();"  enctype="multipart/form-data">
			&nbsp;
			<s:hidden name="strategyFileId" value="%{strategyFileId}"/>
			<s:hidden name="strategyFileName" value="%{strategyFileName}"/>
			<s:hidden name="strategyFileRealName" value="%{strategyFileRealName}"/>
			<s:hidden name="strategyJpgName" value="%{strategyJpgName}"/>
			<s:hidden name="strategyJpgRealName" value="%{strategyJpgRealName}"/>
			<s:hidden name="strategyPhotoFileName" value="%{strategyPhotoFileName}"/>
			<s:hidden name="strategyPhotoRealName" value="%{strategyPhotoRealName}"/>
			<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				<tr>
					<td class="ta_01" align="center" bgColor="#afd1f3" colSpan="4"
						height="26">
						<strong><STRONG>编 辑 攻 略 文 件 信 息</STRONG>
						</strong>
					</td>
				</tr>
				<tr>
