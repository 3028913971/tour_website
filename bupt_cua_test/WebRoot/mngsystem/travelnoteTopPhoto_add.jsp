...
<HTML>
	...
	<body>
		...
		<br>
		<s:form action="travelnoteTopPhoto_add" namespace="/" theme="simple" onsubmit="return CheckTravelnoteTopPhotoForm();" enctype="multipart/form-data">
			&nbsp;
			<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				<tr>
					<td class="ta_01" align="center" bgColor="#afd1f3" colSpan="4"
						height="26">
						<strong><STRONG>添 加 游 记 首 页  图 片 信 息</STRONG>
						</strong>
					</td>
				</tr>
				<tr>	
					...
					<td class="ta_01" bgColor="#ffffff">
						<s:file name="upload" id="uploadFileName" onchange="CheckPhotoType('uploadFileName','游记首页滚动图片','uploadFileNameError')"/>
