...
<HTML>
	<HEAD>
		...
		<script type="text/javascript">
			function addUser(){
				window.location.href = "<c:url value='/mngsystem/travelnoteTopPhoto_add.jsp'/>";
			}
		</script>
	</HEAD>
	<body>
		...
		<br>
		<s:form action="travelnoteTopPhoto_page" namespace="/" theme="simple">
				...
				<TBODY>
								...
								<s:iterator>
									<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td style="CURSOR: hand; HEIGHT: 22px" align="center"
												width="30%">
												<s:property value="travelnoteTopPhotoFileName"/>
											</td>  
											<td style="CURSOR: hand; HEIGHT: 22px" align="center"
												width="30%">
											...
											<td align="center" style="HEIGHT: 22px">
												<s:a action="travelnoteTopPhoto_loadForEdit" namespace="/">
													<s:param name="travelnoteTopPhotoId" value="travelnoteTopPhotoId"/>
													<img src="<c:url value='/images/i_edit.gif'/>" border="0" style="CURSOR: hand">
												</s:a>
											</td>
											<td align="center" style="HEIGHT: 22px">
												<s:a action="travelnoteTopPhoto_delete" namespace="/" onclick="return confirm('您是否真的要删除该记录')">
													<s:param name="travelnoteTopPhotoId" value="travelnoteTopPhotoId"/>
													<s:param name="travelnoteTopPhotoRealName" value="travelnoteTopPhotoRealName"/>
					...
					<tr>
						<td align="center">
							...
							<s:url action="travelnoteTopPhoto_page" namespace="/" id="firstPage">
								<s:param name="pageNum">1</s:param>
							</s:url>
							<s:a href="%{firstPage}" cssStyle="color:blue">[首页]</s:a>
							<s:url action="travelnoteTopPhoto_page" namespace="/" id="prePage">
								<s:param name="pageNum">
									<s:property value="pageNum-1"/>
								</s:param>
							</s:url>
							<s:a href="%{prePage}" cssStyle="color:blue">[上一页]</s:a>
							<s:url action="travelnoteTopPhoto_page" namespace="/" id="nextPage">
								<s:param name="pageNum">
									<s:property value="pageNum+1"/>
								</s:param>
							</s:url>
							...
							<s:url action="travelnoteTopPhoto_page" namespace="/" id="lastPage">
								<s:param name="pageNum">
