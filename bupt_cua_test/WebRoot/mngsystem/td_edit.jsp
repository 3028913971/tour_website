...
<HTML>
	...
	<body>
		...
		<s:form action="td_edit" namespace="/" theme="simple" onsubmit="return CheckTdEditForm();" enctype="multipart/form-data">
			<s:hidden name="cityPhotoFileName" value="%{cityPhotoFileName}"/>
			<s:hidden name="cityPhotoRealName" value="%{cityPhotoRealName}"/>
			<s:hidden name="trafficPhotoFileName" value="%{trafficPhotoFileName}"/>
			<s:hidden name="trafficPhotoRealName" value="%{trafficPhotoRealName}"/>
			<s:hidden name="spotPhotoFileName" value="%{spotPhotoFileName}"/>
			<s:hidden name="spotPhotoRealName" value="%{spotPhotoRealName}"/>
			<s:hidden name="shoppingPhotoFileName" value="%{shoppingPhotoFileName}"/>
			<s:hidden name="shoppingPhotoRealName" value="%{shoppingPhotoRealName}"/>
			<s:hidden name="foodPhotoFileName" value="%{foodPhotoFileName}"/>
			<s:hidden name="foodPhotoRealName" value="%{foodPhotoRealName}"/>
			<s:hidden name="cityName" value="%{cityName}"/>
			<s:hidden name="tdOrder" value="%{tdOrder}"/>
			&nbsp;
			<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				<tr>
					<td class="ta_01" align="center" bgColor="#afd1f3" colSpan="4"
						height="26">
						<strong><STRONG>编辑旅游地信息</STRONG>
						</strong>
					</td>
				</tr>
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff" colSpan="3">
						<s:textfield name="cityName" id="cityName" disabled="true"/>
					</td>
				</tr>
				<tr>
					<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff" colSpan="3">
						<s:checkboxlist value="topSeason.split(', ')" list="{'第一季度（春）','第二季度（夏）','第三季度（秋）','第四季度（冬）'}" name="topSeason" id="topSeason" onblur="CheckRadios('topSeason','热门季节','topSeasonError')" />
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff" colSpan="3">
						<s:checkboxlist value="themeType.split(', ')" list="themeList" name="themeType" id="themeType" onblur="CheckRadios('themeType','主题类型','themeTypeError')"/> 
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff">
						<s:select list="{'国内','国外'}" name="homeOrAbroad" id="homeOrAbroad" headerKey="" headerValue="--请选择--" onchange="CheckNull('homeOrAbroad','国内或国外','homeOrAbroadError')"/>
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff" colSpan="3">
						...
						<span style="color:#ff0000;font-weight:900;"><s:fielderror fieldName="description"/></span>
					</td>
				</tr>
				<tr>
					<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff" colSpan="3">
						...
						<span style="color:#ff0000;font-weight:900;"><s:fielderror fieldName="trafficDescription"/></span>
					</td>
				</tr>
				<tr>
					<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff" colSpan="3">
						...
						<span style="color:#ff0000;font-weight:900;"><s:fielderror fieldName="spotDescription"/></span>
					</td>
				</tr>
				<tr>
					<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff" colSpan="3">
						...
						<span style="color:#ff0000;font-weight:900;"><s:fielderror fieldName="shoppingDescription"/></span>
					</td>
				</tr>
				<tr>
					<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff" colSpan="3">
						...
						<span style="color:#ff0000;font-weight:900;"><s:fielderror fieldName="foodDescription"/></span>
					</td>
				</tr>
				<tr>
					<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
