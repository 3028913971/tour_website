...
<HTML>
	...
	<body>
		...
		<br>
		<s:form action="travelnoteTopPhoto_edit" namespace="/" theme="simple" onsubmit="return CheckNull('isTop','是否热门','isTopError');" enctype="multipart/form-data">
			&nbsp;
			<s:hidden name="travelnoteTopPhotoId" value="%{travelnoteTopPhotoId}"/>
			<s:hidden name="travelnoteTopPhotoFileName" value="%{travelnoteTopPhotoFileName}"/>
			<s:hidden name="travelnoteTopPhotoRealName" value="%{travelnoteTopPhotoRealName}"/>
			<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				<tr>
					<td class="ta_01" align="center" bgColor="#afd1f3" colSpan="4"
						height="26">
						<strong><STRONG>修 改 游 记 首 页 滚 动 图 片 信 息</STRONG>
						</strong>
					</td>
				</tr>
				<tr>	
